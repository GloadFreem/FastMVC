 ...
 * 
 * @see com.jinzht.web.entity.Status
...
public class StatusDAO {
	...
	public Status findById(java.lang.Integer id) {
		...
		try {
			Status instance = (Status) getCurrentSession().get(
					"com.jinzht.web.hibernate.Status", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Status> findByExample(Status instance) {
		...
		try {
			List<Status> results = (List<Status>) getCurrentSession()
					.createCriteria("com.jinzht.web.hibernate.Status")
