 ...
 * 
 * @see com.jinzht.web.entity.Scene
...
public class SceneDAO {
	...
	public static final String TOTLAL_TIME = "totlalTime";
	...
	public void saveOrUpdate(Scene transientInstance) {
		log.debug("saving Scene instance");
		try {
	...
	public List<Scene> findByExample(Scene instance) {
		...
		try {
			List<Scene> results = (List<Scene>) getCurrentSession()
					.createCriteria("com.jinzht.web.hibernate.Scene")
	...
	public List<Scene> findByAudioPath(Object audioPath) {
		return findByProperty(AUDIO_PATH, audioPath);
	}

	public List<Scene> findByTotlalTime(Object totlalTime) {
		return findByProperty(TOTLAL_TIME, totlalTime);
	}
	...
	public Scene merge(Scene detachedInstance) {
		...
		try {
			Scene result = (Scene) getCurrentSession().merge(detachedInstance);
