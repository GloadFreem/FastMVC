...
import com.jinzht.web.entity.Province;
 ...
 * 
 * @see com.jinzht.web.entity.Province
...
public class ProvinceDAO {
	...
	public static final String IS_INVLID = "isInvlid";
	...
	public Province findById(java.lang.Integer id) {
		...
		try {
			Province instance = (Province) getCurrentSession().get(
					"com.jinzht.web.hibernate.Province", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Province> findByExample(Province instance) {
		...
		try {
			List<Province> results = (List<Province>) getCurrentSession()
					.createCriteria("com.jinzht.web.hibernate.Province")
	...
	public List<Province> findByIsInvlid(Object isInvlid) {
		return findByProperty(IS_INVLID, isInvlid);
	}
