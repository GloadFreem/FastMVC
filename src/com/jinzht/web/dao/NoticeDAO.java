 ...
 * 
 * @see com.jinzht.web.entity.Notice
...
public class NoticeDAO {
	...
	public Notice findById(java.lang.Integer id) {
		...
		try {
			Notice instance = (Notice) getCurrentSession().get(
					"com.jinzht.web.hibernate.Notice", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Notice> findByExample(Notice instance) {
		...
		try {
			List<Notice> results = (List<Notice>) getCurrentSession()
					.createCriteria("com.jinzht.web.hibernate.Notice")
	...
	public List<Notice> findByDescription(Object description) {
		return findByProperty(DESCRIPTION, description);
	}

	public List<Notice> findByNoticeType(Object noticeType) {
		return findByProperty(NOTICE_TYPE, noticeType);
	}

	public List<Notice> findByPlatform(Object platform) {
