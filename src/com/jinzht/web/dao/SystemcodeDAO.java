 ...
 * 
 * @see com.jinzht.web.entity.Systemcode
 * @author MyEclipse Persistence Tools
 */
@Transactional
public class SystemcodeDAO {
	private static final Logger log = LoggerFactory
			.getLogger(SystemcodeDAO.class);
	// property constants
	...
	public Systemcode findById(java.lang.Integer id) {
		...
		try {
			Systemcode instance = (Systemcode) getCurrentSession().get(
					"com.jinzht.web.hibernate.Systemcode", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Systemcode> findByExample(Systemcode instance) {
		log.debug("finding Systemcode instance by example");
		try {
			List<Systemcode> results = (List<Systemcode>) getCurrentSession()
					.createCriteria("com.jinzht.web.hibernate.Systemcode")
	...
	public List<Systemcode> findByCode(Object code) {
	...
	public List findAll() {
		...
		try {
			String queryString = "from Systemcode";
			Query queryObject = getCurrentSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Systemcode merge(Systemcode detachedInstance) {
		...
		try {
			Systemcode result = (Systemcode) getCurrentSession().merge(
					detachedInstance);
	...
	public static SystemcodeDAO getFromApplicationContext(ApplicationContext ctx) {
		return (SystemcodeDAO) ctx.getBean("SystemcodeDAO");
	}
}