...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"执行中...",sLengthMenu:"显示 _MENU_ 记录",sZeroRecords:"暂无相关搜索记录",sEmptyTable:"暂无数据",
sLoadingRecords:"记载中...",sInfo:"显示 _START_ to _END_ of _TOTAL_ 记录",sInfoEmpty:"显示 0 to 0 of 0 记录",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sInfoThousands:",",sSearch:"搜索",sUrl:"",oPaginate:{sFirst:"首页",sPrevious:"前一页",sNext:"下一页",sLast:"最后一页"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
