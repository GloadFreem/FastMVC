...
<script type="text/javascript">
        ...
        url = "adminSearchContentsListByKey.action?name=" + name+"&page=0&size=10000";
		...
		<div class="box round first grid">
			<div>
				<a href="adminEditNewsInfo.action?contentId=" target="content"><h2>
						<div>
							<img alt="添加资讯" src="images/圆角矩形-3-拷贝-5.png">
						</div>
						<div>添加资讯</div>
					</h2></a>
			</div>
				...
				<table class="data display datatable" id="example">
					...
					<tbody>
						<c:forEach items="${items}" var="item" varStatus="vs">
							<tr class="odd gradeX">
								<td class="center"><a
									href="adminEditNewsInfo.action?contentId=${item.infoId}"
									target="content">${item.infoId}</a></td>
								<td class="center"><c:forEach
										items="${item.msgImageses}" var="image">
										<a href="${image.url}" target="blank"><img style="width:100px" src="${image.url}"></a>
									</c:forEach></td>
								<td class="center">${item.title}</td>
								<td class="center">${item.webcontenttype.name}</td>
								<td class="center">${item.oringl}</td>
								<td class="center">${item.publicDate}</td>
								<td class="center"><a
									href="adminEditNewsInfo.action?contentId=${item.infoId}"
									target="content"><img alt="编辑" src="../images/write.png" style="width:15px;"></a>|<a href="adminDeleteNewsInfo.action?contentId=${item.infoId}"> <img alt="删除" src="../images/delete.png" style="width:15px;"></a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
