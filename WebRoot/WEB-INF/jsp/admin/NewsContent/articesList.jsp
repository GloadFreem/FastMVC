...
<script type="text/javascript">
        ...
        url = "adminSearchArticesListByKey.action?name=" + name+"&page=0&size=10000";
				...
				<table class="data display datatable" id="example">
					...
					<tbody>
						<c:forEach items="${items}" var="item" varStatus="vs">
							<tr class="odd gradeX">
								<td class="center"><a
									href="adminEditArtic.action?contentId=${item.infoId}"
									target="content">${item.infoId}</a></td>
								<td class="center"><c:forEach
										items="${item.originalImgs}" var="image">
								...
								<td class="center"><a
									href="adminEditArtic.action?contentId=${item.infoId}"
									target="content"><img alt="编辑" src="../images/write.png" style="width:15px;"></a>|<a href="adminDeleteArtic.action?contentId=${item.infoId}"> <img alt="删除" src="../images/delete.png" style="width:15px;"></a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
