...
<body>
	<div class="grid_10">
		<div class="box round first grid">
			<a href="adminEditPush.action?pushId=" target="content"><h2>
					<div>
						<img alt="添加推送" src="images/圆角矩形-3-拷贝-5.png">
					</div>
					<div>添加推送</div>
				</h2></a>
				...
				<table class="data display datatable" id="example">
					...
					<tbody>
						<c:forEach items="${items}" var="item" varStatus="vs">
							<tr class="odd gradeX">
								<td class="center"><a
									href="adminEditPush.action?pushId=${item.messageId}"
									target="content">${item.messageId}</a></td>
								<td class="center">${item.title}</td>
								<td class="center">${item.content}</td>
								<td class="center">${item.messageDate}</td>
								<td class="center">${item.isRead}</td>
