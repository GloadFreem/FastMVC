	...
	$(document).ready(function() {
		$("div.footer-page-item").click(function() {
			...
			if (page != "...") {
				...
				url = "adminActionListAdmin.action?";
				url += "page=" + page;
				url += "&size=" + size;
				window.location = url;
			}
		...
		$(".search-img").click(function() {
			...
			url = "adminSearchActionListByName.action?name=" + name+"&page=0&size=10000";
...
<body>
	<div class="grid_10">
		<div class="box round first grid">
			<div>
				<a href="adminEditAction.action?actionId=" target="content"><h2>
						<div>
							<img alt="添加活动" src="images/圆角矩形-3-拷贝-5.png">
						</div>
						<div>添加活动</div>
					</h2></a>
			</div>
				...
				<table class="data display datatable" id="example">
					...
					<tbody>
						<c:forEach items="${items}" var="item" varStatus="vs">
							<tr class="odd gradeX">
								<td class="center"><a
									href="adminEditAction.action?actionId=${item.actionId}"
									target="content">${item.actionId}</a></td>
