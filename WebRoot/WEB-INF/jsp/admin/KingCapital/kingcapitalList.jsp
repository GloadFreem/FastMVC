...
%>
        ...
        <div><img alt="添加金日投条" src="images/圆角矩形-3-拷贝-5.png"></div>
        <div>添加金日投条</div>
        </h2></a>
        ...
        <c:forEach items="${items}" var="item" varStatus="vs">
            <tr class="odd gradeX">
            <td class="center"><a href="adminEditKingCapital.action?contentId=${item.recordId}"
            target="content">${item.recordId}</a></td>
            <td class="center"><a href="${item.image}" target="blank"><img style="width:200px;" alt="" src="${item.image}"/></a></td>
