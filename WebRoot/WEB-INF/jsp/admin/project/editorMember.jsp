...
<body>
	<div class="content">
		<form action="adminAddMember.action" method="post">
			<!-- 序号 -->
			<c:choose>
				<c:when test="${member!=null}">
					<input style="color:black;visibility:hidden;" name="memberId"
						type="text" value=${member.memberId}>
				</c:when>
				<c:otherwise>
					<input style="visibility:hidden;" name="memberId" type="text"
						value="-1">
				</c:otherwise>
			</c:choose>
			<!-- 名称 -->
			<div class="name">
				...
				<div class="name-value">
					<c:choose>
						...
						<c:otherwise>
							<div class="search">
								<input style="color:black;width:95%" id="companyName" name="companyName"
			...
			<div class="name">
				...
				<div class="name-value">
					<c:choose>
						...
						<c:otherwise>
							<input name="position" type="text" value="请输入职位">
						</c:otherwise>
					</c:choose>
				</div>
			</div>
					...
					<c:choose>
						<c:when test="${member!=null}">
							<input style="color:black" name="industory" type="text"
								value=${member.industory}>
						</c:when>
						<c:otherwise>
							<input name="industory" type="text" value="请输入行业">
						</c:otherwise>
					</c:choose>
				</div>
			</div>
