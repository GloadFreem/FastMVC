	...
	$(document).ready(function() {
		$("div.footer-page-item").click(function() {
			...
			if (page != "...") {
				...
				url = "adminTeamsListAdmin.action?";
				url += "page=" + page;
				url += "&size=" + size;
				window.location = url;
			}
		...
		$(".search-img").click(function() {
			...
			url = "adminSearchTeamListByName.action?name=" + name+"&page=0&size=10000";
...
<body>
	<div class="grid_10">
		...
		<div>
			<a href="adminEditTeam.action?contentId=" target="content"><h2>
					<div>
				...
				<table class="data display datatable" id="example">
					...
					<tbody>
						<c:forEach items="${items}" var="item" varStatus="vs">
							<tr class="odd gradeX">
								<td class="center"><a
									href="adminEditTeam.action?contentId=${item.personId}"
									target="content">${item.personId}</a></td>
