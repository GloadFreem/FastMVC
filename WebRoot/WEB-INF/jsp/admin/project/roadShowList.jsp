	...
	$(document).ready(function() {
		$("div.footer-page-item").click(function() {
			...
			if (page != "...") {
				...
				url = "adminRoadShowListAdmin.action?";
				url += "page=" + page;
				url += "&size=" + size;
				window.location = url;
			}
		...
		$(".search-img").click(function() {
			...
			url = "adminSearchRoadShowListByName.action?name=" + name+"&page=0&size=10000";
		...
		<div class="box round first grid">
			<div>
				...
				<a href="adminEditRoadShow.action?projectId=" target="content"><h2>
						<div>
							<img alt="添加路演" src="images/圆角矩形-3-拷贝-5.png">
						</div>
						<div>添加路演</div>
					</h2></a>
			</div>
				...
				<table class="data display datatable" id="example">
					...
					<tbody>
						<c:forEach items="${items}" var="item" varStatus="vs">
							<tr class="odd gradeX">
								<td class="center"><a
									href="adminEditRoadShow.action?roadShowId=${item.roadShowId}"
									target="content">${item.roadShowId}</a></td>
								<td class="center"><a
