...
<body>
	<div class="grid_10">
		...
		<a href="adminEditFinancestanding.action?financeId=" target="content"><h2>
			...
			<div class="block">
				<table class="data display datatable" id="example">
					...
					<tr class="odd gradeX">
							<td class="center"><a href="adminEditFinancestanding.action?financeId=${item.financeId}" target="content">${item.financeId}</a></td>
