	...
	$(document).ready(function() {
		$("div.footer-page-item").click(function() {
			...
			if (page != "...") {
				...
				url = "adminFinancestandingListAdmin.action?";
				url += "page=" + page;
				url += "&size=" + size;
				window.location = url;
			}
		...
		$("div.footer-page-pre").click(function() {
			...
			url = "adminSearchFinanceStandingListByName.action?name=" + name+"&page=0&size=10000";
	...
	<div class="grid_10">
		<div class="box round first grid">
			<div>
				...
				<a href="adminEditFinancestanding.action?financeId="
					target="content"><h2>
						<div>
				...
				<table class="data display datatable" id="example">
					...
					<tbody>
						<c:forEach items="${items}" var="item" varStatus="vs">
							<tr class="odd gradeX">
								<td class="center"><a
									href="adminEditFinancestanding.action?financeId=${item.financeId}"
									target="content">${item.financeId}</a></td>
