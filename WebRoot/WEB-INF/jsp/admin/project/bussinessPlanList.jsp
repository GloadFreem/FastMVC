	...
	$(document).ready(function() {
		$("div.footer-page-item").click(function() {
			...
			if (page != "...") {
				...
				url = "adminBusinessPlanListAdmin.action?";
				url += "page=" + page;
				url += "&size=" + size;
				window.location = url;
			}
		...
		$("div.footer-page-pre").click(function() {
			...
			url = "adminSearchBuinessPlanListByName.action?name=" + name+"&page=0&size=10000";
...
<body>
	<div class="grid_10">
		<div class="box round first grid">
			<div>
				<a href="adminEditBussinessPlan.action?contentId=" target="content"><h2>
						<div>
				...
				<table class="data display datatable" id="example">
					...
					<tbody>
						<c:forEach items="${items}" var="item" varStatus="vs">
							<tr class="odd gradeX">
								<td class="center"><a
									href="adminEditBussinessPlan.action?contentId=${item.buinessPlanId}"
									target="content">${item.buinessPlanId}</a></td>
