	...
	$(document).ready(function() {
		$("div.footer-page-item").click(function() {
			...
			if (page != "...") {
				...
				url = "adminExitCaseListAdmin.action?";
				url += "page=" + page;
				url += "&size=" + size;
				window.location = url;
			}
		...
		$("div.footer-page-pre").click(function() {
			...
			url = "adminSearchFinanceExitListByName.action?name=" + name+"&page=0&size=10000";
...
<body>
	<div class="grid_10">
		...
		<div>
			<a href="adminEditFinanceExit.action?contentId=" target="content"><h2>
					<div>
				...
				<table class="data display datatable" id="example">
					...
					<tbody>
						<c:forEach items="${items}" var="item" varStatus="vs">
							<tr class="odd gradeX">
								<td class="center"><a
									href="adminEditFinanceExit.action?contentId=${item.financingExitId}"
									target="content">${item.financingExitId}</a></td>
