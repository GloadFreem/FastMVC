...
<script language="JavaScript">
	jQuery(function($) {
		$(".upload").dropzone({
			url : "adminUploadImage.action?flag=Original"
		});
...
<body>
	<form action="adminAddOriginal.action" method="post">
		...
		<div class="name">
			...
			<div class="name-enter">
				<c:choose>
					<c:when test="${msg!=null }">
						<input id="original" name="original" class="add-img-input-style" type="text"
							value="${msg.oringl }" />
					</c:when>
					<c:otherwise>
						<input id="original" name="original" class="add-img-input-style" type="text"
		...
		<div class="name">
			...
			<div class="name-enter">
				<c:choose>
					<c:when test="${msg!=null }">
						<input id="publicDate" name="publicDate" class="add-img-input-style"
							type="text" value="${msg.publicDate }" />
					</c:when>
					<c:otherwise>
						<input id="publicDate" name="publicDate" class="add-img-input-style"
		...
		<div class="name">
			...
			<div class="action-value">
				<c:forEach items="${msg.originalImgs}" var="image">
					<c:choose>
		...
		<div class="editor">
			<c:choose>
				<c:when test="${msg!=null }">
					<c:forEach var="item" items="${msg.originalDetails }">
