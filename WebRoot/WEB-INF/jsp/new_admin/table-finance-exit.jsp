									...
									<c:forEach items="${result}" var="item" varStatus="status">
										<tr>
											<td><input type="checkbox" name="post[]"
												value="${item.financingExitId}"></td>
											<td>${item.financingExitId}</td>
											...
											<td><a
												...
												data-href="deleteUser.action?contentId=${item.financingExitId }&menu=1&sortmenu=1&submenu=1"
...
<script type="text/javascript">
	$("a[name='page']").click(
			function() {
				...
				var submenu = ${submenu};
				var url = "financeExitList.action?" + "size=" + size + "&page="
