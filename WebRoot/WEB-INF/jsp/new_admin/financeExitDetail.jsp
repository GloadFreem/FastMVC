...
<section id="content">
	<section class="vbox">
		...
		<section class="scrollable wrapper">
			<form action="adminAddProjectFinanceExit.action?menu=4&sortmenu=7&submenu=1"
				method="post" enctype="multipart/form-data">
				<ul>
					<li class="list-group-item">
						<div class="">
							<input name="contentId" value="${data.financingExitId}"
								style="display:none">
					...
					$.ajax({
						...
						success : function(data) {
							...
							data.data.forEach(function(e) {
								select = "<option value='"+e.projectId+"'>" + e.fullName
										+ "</option>"
