								...
								<c:when test="${result != null}">
									<c:forEach items="${result}" var="item" varStatus="status">
										<tr>
											...
											<td><a href="newBannerDetail.action?contentId=${item.bannerId }&menu=2&sortmenu=0&submenu=1" class="active"><i
													class="fa fa-edit text-success text-active"></i><i
													class="fa fa-edit text-danger text"></i></a> | <a
												href="#modal" data-href="delNewsBanner.action?contentId=${item.bannerId }&menu=2&sortmenu=0&submenu=1" data-toggle="modal"
												class="active"><i
