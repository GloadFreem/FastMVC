	...
	<section class="vbox">
		<section class="scrollable padder">
			<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
				...
				<li><a href="index.action"><i class="fa"></i> 路演管理</a></li>
				<li><a href="index.action"><i class="fa"></i> 路演列表</a></li>
			</ul>
			<section class="panel panel-default">
				<header class="panel-heading"> 路演列表 </header>
...
<script type="text/javascript">
	$("a[name='page']").click(
			function() {
				...
				var submenu = ${submenu};
				var url = "roadshowList.action?" + "size=" + size + "&page="
