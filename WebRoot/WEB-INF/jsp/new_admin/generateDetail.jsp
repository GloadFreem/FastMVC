...
<section id="content">
	<section class="vbox">
		...
		<section class="scrollable wrapper">
			<form action="generateDetail.action?menu=1&sortmenu=2&submenu=1"
				...
				<li class="list-group-item">
					<div class="clear">邀请码数量</div>
				</li>
				<li class="list-group-item"><input name="count"
					class="form-control alert-success" value="5" placeholder="请输入内容类型">
					</div></li>
