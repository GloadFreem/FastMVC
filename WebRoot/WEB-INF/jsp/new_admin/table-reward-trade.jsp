								...
								<c:when test="${result != null}">
									<c:forEach items="${result}" var="item" varStatus="status">
										<tr>
											...
											<td><a href="${item.rewardsystem.users.headSculpture}" /><img
												alt="${item.rewardsystem.users.name}" src="${item.rewardsystem.users.headSculpture}"
...
<script type="text/javascript">
	$("a[name='page']").click(
			function() {
				...
				var submenu = ${submenu};
				var url = "rewardTradeList.action?" + "size=" + size + "&page="
