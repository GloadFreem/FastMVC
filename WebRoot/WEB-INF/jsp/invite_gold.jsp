...
<body class="d-body body-background" style="overflow-x: hidden; background-color:#ffb900">
	<div class="gold">
		<div>
			<img class="invite-img" alt="bg" src="./images/share/形状-13.png">
		</div>
		<div class="gold-header">
			<img class="gold-header-img1" alt="bg"
				src="./images/share/形状-1.png">
		</div>
		<div class="gold-code">
			<img class="gold-header-img2" alt="bg"
				src="./images/share/组-11.png">
		</div>
		<div class="gold-code1">
			<img class="gold-header-img3" alt="bg"
				src="./images/share/lihe.png">
		</div>
		<div class="gold-qr-code">
			<img class="gold-qr-code-img" alt="bg"
				src="./images/share/指环码.png">
		</div>
		<div class="king-code">
			<div class="king-code-text">jzt_0000_0001T</div>
			<div class="king-code-img-wrapper">
				<img class="king-code-img" alt="bg"
				src="./images/share/复制.png">
			</div>
		...
		<div class="er-code">
			<div class="er-code-img"><img class="king-code-img" alt="bg"
				src="./images/share/2015-09-02-1530101789.png"></div>
