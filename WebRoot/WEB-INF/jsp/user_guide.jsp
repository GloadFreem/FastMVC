...
<body class="d-body" style="overflow-x: hidden;">
	...
	<p class="commit-desc-line2-p">
	No.<font size="30px">1</font>
	</p>
	</div>
	<div class="upload-desc-line">
	<p class="commit-desc-line2-p">进入金指投APP</p>
	</div>
	<div class="upload-desc-line">
	<p class="commit-desc-line2-p">
	...
	<div class="upload-desc-line">
	<p class="commit-desc-line2-p">进入Logo菜单中心</p>
	</div>
	</div>
	<!-- 底部菜单 -->
	<div class="menu">
	...
	<div class="menu-desc-line">
	<p class="commit-desc-line2-p">在Logo菜单中</p>
	</div>
	<div class="menu-desc-line">
	<p class="commit-desc-line2-p">
	...
	<div class="menu-desc-line">
	<p class="commit-desc-line2-p">进行上传</p>
	</div>
	</div>
	...
	<div class="commit-desc-line">
	<p class="commit-desc-line2-p">发送给我们</p>
	</div>
	<div class="commit-desc-line">
	<p class="commit-desc-line2-p">审核完成后我们会</p>
	</div>
	<div class="commit-desc-line">
	<p class="commit-desc-line2-p">帮您上传</p>
	</div>
	</div>
	...
	<div class="upload-desc-line">
	<p class="commit-desc-line2-p">选择您看好的</p>
	</div>
	<div class="upload-desc-line">
	<p class="commit-desc-line2-p">
	...
	<div class="upload-desc-line" style="width: 48%">
	<p class="commit-desc-line2-p" >
	No.<font size="30px">2</font>
	</p>
	</div>
	...
	<div class="upload-desc-line" style="width: 48%">
	<p class="commit-desc-line2-p">进入项目认投页面</p>
	</div>
	</div>
	...
	<div class="confirm-desc-line">
	<p class="commit-desc-line2-p">在认投页面输入金额</p>
	</div>
	<div class="confirm-desc-line">
	<p class="commit-desc-line2-p">并选择投资意向</p>
	</div>
	<div class="confirm-desc-line">
	<p class="commit-desc-line2-p">
	...
	<div class="submmit-desc-line">
	<p class="commit-desc-line2-p">进行支付</p>
	</div>
	<div class="submmit-desc-line">
	<p class="commit-desc-line2-p">完成项目认投</p>
	</div>
	</div>
	<div class="foot-box">
